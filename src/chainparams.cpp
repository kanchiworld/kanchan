...
static CBlock CreateGenesisBlock(const char* pszTimestamp, const CScript& genesisOutputScript, uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward)
{
    ...
    txNew.vin.resize(1);
    txNew.vout.resize(1);
//  Gautam - I should probably use 504365040 as nBits. 504365040 =  0x1e0ffff0  486604799  = 0x1d00ffff
...
//    const char* pszTimestamp = "kanchan will rule the world";
    const char* pszTimestamp = "Charlotte, North Carolina, 10/05/2007. kanchan is born, and kanchan will rule the world.";
//    const CScript genesisOutputScript = CScript() << ParseHex("040184710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
    const CScript genesisOutputScript = CScript() << ParseHex("044639a316023891bbfdbdaf5814671e8e4d0a2f47bfc515a3fb1a11e54787bcfab662ebe81342676d8ab38d871a2c671ab2b26f758f441c9e2168408bf495b625") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.nSuperblockStartBlock = 1; // The block at which 12.1 goes live (end of final 12.0 budget cycle) //Gautam
        //consensus.nSuperblockStartHash = uint256S("0000000000020cb27c7ef164d21003d5d20cdca2f54dd9a9ca6d45f4d47f8aa3");
        consensus.nSuperblockStartHash = uint256S("000006468edf894ea4f0a5a4a263e11b74867ae81a0cd6c8a1de373c7ab91c37"); //Gautam //This is block num 1.
        consensus.nSuperblockCycle = 16616; // ~(60*24*30)/2.6, actual number of blocks per month is 200700 / 12 = 16725
        consensus.nGovernanceMinQuorum = 10;
        consensus.nGovernanceFilterElements = 20000;
        consensus.nMasternodeMinimumConfirmations = 15;
        //consensus.BIP34Height = 951;
        consensus.BIP34Height = 1; //Gautam
        //consensus.BIP34Hash = uint256S("0x000001f35e70f7c5705f64c6c5cc3dea9449e74d5b5c7cf74dad1bcca14a8012");
        consensus.BIP34Hash = uint256S("0x000006468edf894ea4f0a5a4a263e11b74867ae81a0cd6c8a1de373c7ab91c37"); //Gautam
        //consensus.BIP65Height = 619382; // 00000000000076d8fcea02ec0963de4abfd01e771fec0863f960c2c64fe6f357
        consensus.BIP65Height = 1; // 00000000000076d8fcea02ec0963de4abfd01e771fec0863f960c2c64fe6f357 //Gautam
        //consensus.BIP66Height = 245817; // 00000000000b1fa2dfa312863570e13fae9ca7b5566cb27e55422620b469aefa
        consensus.BIP66Height = 1; // 00000000000b1fa2dfa312863570e13fae9ca7b5566cb27e55422620b469aefa //Gautam
        ...
        consensus.DIP0003EnforcementHash = uint256S("000006468edf894ea4f0a5a4a263e11b74867ae81a0cd6c8a1de373c7ab91c37"); //Gautam
        consensus.powLimit = uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"); // ~uint256(0) >> 20
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Kanchan: 1 day
        consensus.nPowTargetSpacing = 2.5 * 60; // Kanchan: 2.5 minutes
...
//Gautam changed in circular fashion. 0xbf -> 0xbd 0x0c -> 0x0f 0x6b -> 0x6c 0xbd -> 0xbb
...
//        assert(genesis.hashMerkleRoot == uint256S("0xe0028eb9648db56b1ac77cf090b99048a8007e2bb64b68f092c03c7f56a662c7"));
        //assert(consensus.hashGenesisBlock == uint256S("0x0000037780ccac47eef63c7cb1a8e349c013a32956b3a90d17b5ff0bb4ae74a4"));
        //assert(genesis.hashMerkleRoot == uint256S("0x7e88539980c302ec71b443edca8d92720d477a0d024c99f42da3e9fcdbf29e20"));
        assert(consensus.hashGenesisBlock == uint256S("0x00000f45adcf12d5bbcb9494cc7733bbe35de32b2ee2709d9021851c74f2806a"));
        assert(genesis.hashMerkleRoot == uint256S("0x169d769573fa4c5254484b31d730909aa90e5916d1ddc6b11372002b1eff8ac2"));

        vSeeds.emplace_back("dnsseed.kanchiworld.com", true);
        vSeeds.emplace_back("dnsseed.kanchiworld.org", true);
        vSeeds.clear(); //Gautam

        // Kanchan addresses start with 'X'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,76);
        // Kanchan script addresses start with '7'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,16);
        // Kanchan private keys start with '7' or 'X'
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,204);
        // Kanchan BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x88, 0xB2, 0x1E};
        // Kanchan BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x88, 0xAD, 0xE4};

        // Kanchan BIP44 coin type is '5'
        nExtCoinType = 5;
...
*/
        checkpointData = (CCheckpointData) {
            {
                //{0, uint256S("0x000003aafc29e72a07d392dc0264eba23869f55de90f484f37b3fffaa9c2e9da")},
                {0, uint256S("0x00000f45adcf12d5bbcb9494cc7733bbe35de32b2ee2709d9021851c74f2806a")},
            }
        };
...
*/
        chainTxData = ChainTxData{
            1191622160, // * UNIX timestamp of last known number of transactions (Block 0)
...
//        genesis = CreateGenesisBlock(1390666206UL, 3861367235UL, 0x1e0ffff0, 1, 50 * COIN);
        genesis = CreateGenesisBlock(1390666206UL, 1203863UL, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        //assert(consensus.hashGenesisBlock == uint256S("0x00000bafbc94add76cb75e2ec92894837288a481e5c005f6563d91623bf8bc2c"));
        //assert(genesis.hashMerkleRoot == uint256S("0xe0028eb9648db56b1ac77cf090b99048a8007e2bb64b68f092c03c7f56a662c7"));
//Gautam blocked these two lines
        //assert(consensus.hashGenesisBlock == uint256S("0x0000052bd5a9fa60fefae03c8280a1c211697b5e2495f5bae7605425cd11c545"));
        //assert(genesis.hashMerkleRoot == uint256S("0x7e88539980c302ec71b443edca8d92720d477a0d024c99f42da3e9fcdbf29e20"));
        ...
        vSeeds.emplace_back("testnet-seed.kanchiworld.com", true);

        // Testnet Kanchan addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
        // Testnet Kanchan script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Testnet Kanchan BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Testnet Kanchan BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Testnet Kanchan BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
...
public:
    CDevNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("kanchiworld.com",  "devnet-seed.kanchiworld.com"));
...
public:
    CRegTestParams() {
        ...
        // Regtest Kanchan addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
        // Regtest Kanchan script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Regtest Kanchan BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Regtest Kanchan BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Regtest Kanchan BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
