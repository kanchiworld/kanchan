    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    } else if (helpMode == cmdline)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  kanchan-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Kanchan in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.001 KANCHAN, 0.01 KANCHAN, 0.1 KANCHAN, 1 KANCHAN and 10 KANCHAN -- sort of like the paper money you use every day.</li> \
