...
std::cout << "Point K.2" << std::endl;
    rpcConsole = new RPCConsole(_platformStyle, 0);
std::cout << "Point K.3" << std::endl;
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Kanchan address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and kanchan: URIs)"));
    ...
    aboutAction->setStatusTip(tr("Show information about Kanchan Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Kanchan addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Kanchan addresses"));
    ...
    openAction->setStatusTip(tr("Open a kanchan: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Kanchan command-line options").arg(tr(PACKAGE_NAME)));
...
void BitcoinGUI::createToolBars()
{
    ...
    if(walletFrame)
    {
        ...
        // Add Kanchan logo on the right side
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Kanchan network", "", count));
    } else {
...
void BitcoinGUI::setNumBlocks(int count, const QDateTime& blockDate, double nVerificationProgress, bool header)
{
    ...
    //qint64 secs = blockDate.secsTo(currentDate); //Gautam
    qint64 secs = 0;
...
{
    QString strTitle = tr("Kanchan Core"); // default title
