...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/kanchiworld/kanchan>";
    const std::string URL_WEBSITE = "<https://kanchiworld.com>";
...
/** Sanity checks
 *  Ensure that Kanchan Core is running in a usable environment with all
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Kanchan Core version %s\n", FormatFullVersion());
}
...
static bool LockDataDirectory(bool probeOnly)
{
    ...
    // Make sure only a single Kanchan Core process is using the data directory.
...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    // lite mode disables all Kanchan-specific functionality
    ...
    // ********************************************************* Step 10c: schedule Kanchan-specific tasks
