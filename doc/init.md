...
see `contrib/debian/examples/kanchan.conf`.
...
Configuration file:  `/etc/dashcore/kanchan.conf`  
...
Configuration file:  `~/Library/Application Support/KanchanCore/kanchan.conf`  
Data directory:      `~/Library/Application Support/KanchanCore`
Lock file:           `~/Library/Application Support/KanchanCore/.lock`
